...
public class Utils
{
    ...
    {
        _logger.WriteLine($"[Kotone UI Overhaul] {message}");
    }

    internal static void LogError(string message, Exception e)
    {
        _logger.WriteLine($"[Kotone UI Overhaul] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[Kotone UI Overhaul] {message}", System.Drawing.Color.Red);
    }
